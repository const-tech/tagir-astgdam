        ...
        <div class="">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                ...
                <div class="d-flex align-items-center gap-1">
                    <button class="main-btn fs-13px" wire:click='$set("screen","create")'>
                        @lang('Add')
                        <i class="fas fa-plus fs-13px"></i>
                    </button>
                    <button class="btn btn-sm text-light btn-warning rounded-0" id="btn-prt-content">
            ...
            <div class="bar-options d-flex align-items-center justify-content-between flex-wrap gap-3 mb-2">
                <div class="d-flex align-items-center flex-wrap gap-1">
                    <button class="main-btn btn-main-color" wire:click='$set("filter_active","")'>
                        @lang('All companies'):
                        {{ $allClients->count() }}
                    </button>
                    <button class="main-btn" wire:click="$set('filter_active','active')">
                        @lang('Activated companies'):
                        {{ \App\Models\User::Clients()->Active()->count() }}
                    </button>
                    <button class="main-btn bg-danger" wire:click="$set('filter_active','inactive')">
                        @lang('Unactivated companies'):
                        {{ \App\Models\User::Clients()->InActive()->count() }}
                    </button>
                </div>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <button type="button" class="dropdown-item text-center"
                                                        data-bs-toggle="modal" data-bs-target="#sendToWhatsapp"
