...
<div class="col-12 col-md-4 col-lg-3">
    <div class="form-group">
        <label for="id">@lang('choose_from_members')</label>
        <select wire:model.live="selected" class="form-control users_id" name="id" id="id">
            <option value="">@lang('choose')</option>
            <option value="all_users">@lang('send_to_all_members')</option>
            <option value="one_user">@lang('property_owner')</option>
            <option value="two_user">@lang('client')</option>
        </select>
    </div>
</div>
...
@if($selected == 'one_user')
    <div class="col-12 col-md-4 col-lg-3">
        <div class="form-group">
            <label for="id">@lang('choose_member')</label>
...
<div class="col-12 col-md-4 col-lg-3 my-2">
    <div class="form-group">
        <label for="id">@lang('choose_message')</label>
...
<div class="col-12">
    <button wire:click="submit" class="main-btn px-4">@lang('send')</button>
</div>
