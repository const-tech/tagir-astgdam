<section class="main-side">
    <button wire:click="downloadPdf" class="btn btn-success btn-sm">{{ __('download PDF') }}</button>
    <button wire:click="sendMail" class="btn btn-primary btn-sm">{{ __('send email') }}</button>
            ...
            <div class="app-price" id="html2pdf">
                <section class="price-page">
                    ...
                    <div class="content-page">
                        ...
                        <p class="fw-bold mb-2">مدير التطوير ِالأعمال: ماجد سلامه </p>
                        <p class="fw-bold mb-2"> رقم التواصل : {{ setting('phone') }} </p>
                        <p class="fw-bold mb-2"> معد عرض السعر : {{ $price_quotation->created_by }} </p>
                        <p class="fw-bold mb-2"> رقم التواصل : {{ $price_quotation->created_by_phone }} </p>
{{--                        <p class="fw-bold mb-2"> رقم التواصل : {{ setting('phone') }} </p>--}}
